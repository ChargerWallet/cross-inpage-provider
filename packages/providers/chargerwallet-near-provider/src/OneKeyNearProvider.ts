...
declare interface ChargerWalletNearProvider {
  ...
  on<U extends keyof ChargerWalletNearProviderEventsMap>(
    event: U,
    listener: ChargerWalletNearProviderEventsMap[U],
    context?: any,
  ): this;
  emit<U extends keyof ChargerWalletNearProviderEventsMap>(
    event: U,
    ...args: Parameters<ChargerWalletNearProviderEventsMap[U]>
  ): boolean;
}
...
class ChargerWalletNearProvider extends ProviderNearBase {
  ...
  _authDataKey = '@ChargerWalletNearWalletAuthData';
