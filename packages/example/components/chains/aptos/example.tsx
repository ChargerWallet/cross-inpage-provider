...
import { SignMessagePayload } from '@chargerwallet/chargerwallet-aptos-provider/dist/types';
...
export default function Example() {
  const walletsRef = useRef<IProviderInfo[]>([
    ...
    {
      uuid: 'injected-chargerwallet',
      name: 'Injected ChargerWallet',
      inject: '$chargerwallet.aptos',
    },
  ]);
  ...
  const onConnectWallet = async (selectedWallet: IKnownWallet) => {
    ...
    const provider = get(window, providerDetail.inject) ;
