...
export default class BaseProvider extends ProviderBase {
  ...
  constructor(config: IInpageProviderConfig) {
    ...
    const disconnectHandler = this._handleStreamDisconnect.bind(this, 'Charger Wallet');
    ...
    // TODO jsBridge disconnect event
    const disconnectHandlerRpc = this._handleStreamDisconnect.bind(this, 'Charger Wallet RpcProvider');
