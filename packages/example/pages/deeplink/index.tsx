    ...
    <PageLayout title="DeepLink Test">
      ...
      {uri && (
        <ul className="list-disc pl-5">
          {[
            {
              href: `https://app.chargerwallet.com/wc/connect?uri=${uriEncoded}`,
              text: 'UniversalLink (full link)',
            },
            {
              href: 'https://app.chargerwallet.com/account/0xA9b4d559A98ff47C83B74522b7986146538cD4dF',
              text: 'UniversalLink (account)',
            },
            { href: 'wc://', text: 'wc:// (empty link)' },
            { href: 'chargerwallet-wallet://', text: 'chargerwallet-wallet:// (empty link)' },
            { href: uri, text: 'wc: (full link)' },
            {
              href: `chargerwallet-wallet:/wc?uri=${uriEncoded}`,
              text: 'chargerwallet-wallet:/wc?uri= (full link)',
            },
            {
              href: `chargerwallet-wallet://wc?uri=${uriEncoded}`,
              text: 'chargerwallet-wallet://wc?uri= (full link)',
