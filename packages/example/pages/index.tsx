  ...
  return (
    <div className="container mx-auto p-2">
      ...
      <footer className={styles.footer}>
        ...
        <iframe
          src="https://ghbtns.com/github-btn.html?user=chargerwallet&repo=cross-inpage-provider&type=star&count=true"
          frameBorder="0"
          scrolling="0"
          title="GitHub"
          height={20}
          width={100}
        />
        <a href="https://www.chargerwallet.com" target="_blank" rel="noopener noreferrer">
          Powered by ChargerWallet →
        </a>
      </footer>
    </div>
  );
