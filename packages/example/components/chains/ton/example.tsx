...
export default function App() {
  ...
  const manifestUrl = enable ? "https://dapp-example.chargerwallettest.com/scam-tonconnect-manifest.json" : "https://dapp-example.chargerwallettest.com/tonconnect-manifest.json";
          ...
          includeWallets: [
            {
              ...
              name: "ChargerWallet",
              imageUrl: "https://common.chargerwallet-asset.com/logo/chargerwallet-x288.png",
              aboutUrl: "https://chargerwallet.com",
              jsBridgeKey: "chargerwalletTonWallet",
              platforms: ["chrome"]
            },
          ]
        }}>
