...
const data: ITreeNodeData[] = [
  {
    ...
    children: [
      ...
      { id: uuid.v4(), name: 'DeepLink', href: '/deeplink' },
      {
        id: uuid.v4(),
        name: 'Hardware SDK',
        href: 'https://hardware-example.chargerwallettest.com/',
      },
    ],
  },
  {
...
const Home: NextPage = () => {
  ...
  //   global?.$chargerwallet?.ethereum?.request({ method: 'net_version' }).then((res: any) => {
  ...
  return (
    <div className="container mx-auto p-2">
      <Head>
        <title>Dapp Example - ChargerWallet</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>

      <header className="flex flex-row items-center justify-between">
        <h2 className="text-2xl font-bold">Dapp Example - ChargerWallet</h2>
      ...
      <footer className={styles.footer}>
        ...
        <iframe
          src="https://ghbtns.com/github-btn.html?user=ChargerWalletHQ&repo=cross-inpage-provider&type=star&count=true"
          frameBorder="0"
          scrolling="0"
          title="GitHub"
          height={20}
          width={100}
        />
        <a href="https://www.chargerwallet.so" target="_blank" rel="noopener noreferrer">
          Powered by Charger Wallet →
        </a>
      </footer>
    </div>
  );
