          ...
          onGenerateRequest={() => {
            ...
            return Promise.resolve(
              JSON.stringify({
                ...
                resources: ['https://chargerwallet.com'],
              }),
            );
          }}
          onExecute={async (request: string) => {
...
export default function App() {
  ...
  const endpoint = useMemo(() => 'https://node.chargerwallet.com/sol', [network]);
  ...
  return (
    <ConnectionProvider endpoint={endpoint}>
      <WalletProvider wallets={wallets} autoConnect localStorageKey="chargerwallet_sol_dapp_example">
        <WalletModalProvider>
          <Example />
        </WalletModalProvider>
      </WalletProvider>
