...
export class ChargerWalletSolanaStandardWallet implements Wallet {
  readonly #listeners: { [E in StandardEventsNames]?: StandardEventsListeners[E][] } = {};
  readonly #version = '1.0.0' as const;
  readonly #name = 'Charger Wallet' as const;
  readonly #icon: WalletIcon;
  #account: ChargerWalletSolanaWalletAccount | null = null;
  ...
  #connected = () => {
      ...
      if (address) {
          ...
          if (!account || account.address !== address || !bytesEqual(account.publicKey, publicKey)) {
              this.#account = new ChargerWalletSolanaWalletAccount({ address, publicKey });
